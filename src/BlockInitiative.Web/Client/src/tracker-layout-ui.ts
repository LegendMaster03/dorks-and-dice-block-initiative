...
.block-initiative-app.bi-dense-tracker .bi-roster-header{
  display:grid;gap:.45rem;align-items:end;padding:0 .15rem .2rem;
  font-size:.76rem;font-weight:700;letter-spacing:.02em;opacity:.68;text-transform:uppercase
}
.block-initiative-app.bi-dense-tracker .bi-player-roster-header{grid-template-columns:minmax(12rem,1fr) 5rem minmax(9rem,11rem) auto}
.block-initiative-app.bi-dense-tracker .bi-enemy-roster-header{grid-template-columns:minmax(12rem,1fr) 5rem minmax(9rem,11rem) minmax(20rem,24rem) auto}

.block-initiative-app.bi-dense-tracker .bi-roster-entry{
  display:grid;gap:.45rem;align-items:center;padding:.42rem .15rem!important;
  border:0!important;border-bottom:1px solid var(--bi-border)!important;border-radius:0!important
}
.block-initiative-app.bi-dense-tracker .bi-player-entry{grid-template-columns:minmax(12rem,1fr) 5rem minmax(9rem,11rem) auto}
.block-initiative-app.bi-dense-tracker .bi-enemy-entry{grid-template-columns:minmax(12rem,1fr) 5rem minmax(9rem,11rem) minmax(20rem,24rem) auto}
.block-initiative-app.bi-dense-tracker .bi-roster-entry>.bi-entry-main{display:contents!important}
.block-initiative-app.bi-dense-tracker .bi-roster-entry [data-role='name-field']{grid-column:1}
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-initiative-modifier{grid-column:2}
.block-initiative-app.bi-dense-tracker .bi-roster-entry [data-role='initiative-wrap']{grid-column:3}
.block-initiative-app.bi-dense-tracker .bi-enemy-entry>[data-combat-setup='standard']{grid-column:4}
.block-initiative-app.bi-dense-tracker .bi-enemy-entry>.bi-entry-main>button[data-action='remove']{grid-column:5}
.block-initiative-app.bi-dense-tracker .bi-player-entry>.bi-entry-main>button[data-action='remove']{grid-column:4}
.block-initiative-app.bi-dense-tracker .bi-roster-entry>.bi-entry-main>button[data-action='remove']{
  justify-self:end;width:auto!important;min-width:0;padding:.25rem .5rem;white-space:nowrap
}
...
.block-initiative-app.bi-dense-tracker .bi-roster-entry [data-role='initiative-wrap']{
  display:grid!important;grid-template-columns:minmax(5rem,5.5rem) auto;gap:.3rem;align-items:center
}
...
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-roll-line{grid-column:2;margin:0!important;gap:.3rem;flex-wrap:nowrap!important}
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-roll-line .btn{padding:.25rem .45rem;white-space:nowrap}
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-roll-audit{white-space:nowrap}
...
.block-initiative-app.bi-dense-tracker .bi-roster-entry>.bi-template-actions{grid-column:1/-1;margin:.05rem 0 0}
...
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-hp-controls{
  display:flex!important;flex-wrap:nowrap!important;gap:.35rem!important;align-items:center!important;margin:0!important
}
...
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-hp-adjust>.bi-field{min-width:4.25rem!important;max-width:4.75rem!important;flex:0 0 4.5rem!important}
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-hp-fraction input,
.block-initiative-app.bi-dense-tracker .bi-roster-entry .bi-hp-adjust input{width:4.5rem!important;max-width:4.5rem!important}
...
.block-initiative-app.bi-dense-tracker .bi-group-head{padding:.45rem .15rem!important;background:transparent!important;border-bottom:0!important;align-items:center}
...
.block-initiative-app.bi-dense-tracker .bi-group-head .bi-badges{gap:.3rem}
...
@media(max-width:900px){
  ...
  .block-initiative-app.bi-dense-tracker .bi-enemy-entry{grid-template-columns:minmax(10rem,1fr) 5rem minmax(9rem,11rem) auto}
  .block-initiative-app.bi-dense-tracker .bi-enemy-entry>[data-combat-setup='standard']{grid-column:1/4;grid-row:2}
